...
type_map = {
    default_blob_dir_media_type: oras.schemas.layer,
    default_blob_media_type: oras.schemas.layer,
    default_manifest_media_type: oras.schemas.manifest,
    default_index_media_type: oras.schemas.index,
}
